...
%   Copyright 2014 The MathWorks, Inc.
   ...
   function init_code
      ...
      uicontrol('style','push','string','depth', ...
         'units','normalized','position',[0.16 0.20 0.12 0.06], ...
         'callback','cla, morse_code(''_depth'')')
      uicontrol('style','push','string','breadth', ...
         'units','normalized','position',[0.35 0.20 0.12 0.06], ...
         'callback','cla, morse_code(''_breadth'')')
      uicontrol('style','togglebutton','string','sound','value',1, ...
         'units','normalized','position',[0.54 0.20 0.12 0.06]);
      uicontrol('style','togglebutton','string','extend','value',0, ...
         'units','normalized','position',[0.72 0.20 0.12 0.06], ...
      ...
      uicontrol('style','edit','string', ...
         ...
         'units','normalized','position',[0.16 0.04 0.68 0.08], ...
